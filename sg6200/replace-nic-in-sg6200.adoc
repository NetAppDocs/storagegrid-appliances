...
| 1
| NIC 1 in the one-slot riser assembly
| 10/25-GbE Ethernet network ports for Grid and Client Networks

| 2
| NIC 2 in the one-slot riser assembly
| 1/10-GbE	Ethernet network ports for Admin Network

| 3
| NIC 3 in the one-slot riser assembly
| 10/25-GbE Ethernet network ports for Grid and Client Networks

|===
+
NOTE:: Some appliances support higher speed network ports and might have higher speed NICs installed.
