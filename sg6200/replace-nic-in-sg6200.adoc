...
* You have link:locating-sgf6212-in-data-center.html[physically located the SGF6212 appliance or SG6200-CN controller] where you are replacing the NIC in the data center.
+
