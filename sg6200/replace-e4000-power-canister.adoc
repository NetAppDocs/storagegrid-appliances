...
---
= Replace power canister in storage controller shelf or expansion shelf (SG6260)
:experimental:
:icons: font
:imagesdir: ../media/

[.lead]
You can replace a power canister in an SG6260 storage controller shelf or expansion shelf (DE460C).
