...
* You have link:locating-sgf6212-in-data-center.html[physically located the appliance] with the power supply to be replaced.
...
The figure shows the two power supply units for the SGF6212 appliance or SG6200-CN compute node. The power supplies are accessible from the back of the appliance. 
