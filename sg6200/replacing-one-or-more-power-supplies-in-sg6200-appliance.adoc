...
summary: 'The SGF6212 appliance and SG6200-CN compute node have two power supplies for redundancy. If one of the power supplies fails, you must replace it as soon as possible to ensure that the appliance has redundant power. Both power supplies operating in the appliance must be of the same model and wattage.'
---
= Replace one or both power supplies in the SGF6212 or SG6200-CN
:icons: font
:imagesdir: ../media/

[.lead]
The SGF6212 appliance and SG6200-CN compute node have two power supplies for redundancy. If one of the power supplies fails, you must replace it as soon as possible to ensure that the appliance has redundant power. Both power supplies operating in the appliance must be of the same model and wattage.

// Same procedure for SG120 and SG1200 - unable to use includes due to specific links in steps.

.About this task

The figure shows the location of the two power supply units. The power supplies are accessible from the back of the appliance. 

image::../media/sgf6212_power_supplies.png["Back of SGF6212 or SG6200-CN with two power supplies"] 
+
NOTE: The image shows the SGF6212 appliance, but the power supplies are located in the same position on the SG6200-CN compute node.


.Before you begin

* You have link:locating-sg6200-in-data-center.html[physically located the appliance] with the power supply to be replaced.
...
.. link:power-sg6200-off-on.html#shut-down-the-sgf6212-appliance-or-sg6200-cn-controller[Shut down the appliance].
+
