...
* You have link:reinstalling-sg6200-into-cabinet-or-rack.html[installed the controller in a cabinet or rack] and connected the data and power cables.

* You have link:locating-sg6200-in-data-center.html[physically located the controller in the data center].
