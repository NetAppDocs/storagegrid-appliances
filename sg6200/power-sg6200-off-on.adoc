...
summary: 'You can shut down the sg6200 appliance and power it back on to perform maintenance.'
---
= Power SGF6212 appliance or SG6200-CN controller off and on
:icons: font
:imagesdir: ../media/

[.lead]
You can shut down the SGF6212 appliance or SG6200-CN controller and power them back on to perform maintenance.
...
* You have link:reinstalling-sgf6212-into-cabinet-or-rack.html[installed the controller in a cabinet or rack] and connected the data and power cables.

* You have link:locating-sgf6212-in-data-center.html[physically located the controller in the data center].
...
+
image::../media/sgf6212_power_on_from_bmc.png["Power on appliance from BMC"] 
+
