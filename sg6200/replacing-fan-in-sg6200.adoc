...
* You have link:locating-sgf6212-in-data-center.html[physically located the SGF6212 appliance or SG6200-CN controller] where you are replacing the fan in the data center.
+
NOTE: A link:power-sgf6212-off-on.html#shut-down-the-sgf6212-appliance-or-sg6200-cn-controller[controlled shutdown of the appliance] is required before removing the appliance from the rack.

* You have disconnected all cables and link:reinstalling-sgf6212-cover.html[removed the appliance cover].
...
. link:reinstalling-sgf6212-cover.html[Put the top cover back on the appliance], and press the latch down to secure the cover in place.
