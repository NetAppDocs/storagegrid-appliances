...
+
link:locating-sg6200-in-data-center.html[Locate controller in data center]
...
. If the SG6200-CN controller is functioning sufficiently to allow for a controlled shutdown, link:power-sg6200-off-on.html[shut down the SG6200-CN controller].
