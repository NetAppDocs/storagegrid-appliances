...
summary: 'You might need to replace the SG6200-CN controller if it is not functioning optimally or if it has failed.'
---
= Replace SG6200-CN controller
:icons: font
:imagesdir: ../media/

[.lead]
You might need to replace the SG6200-CN controller if it is not functioning optimally or if it has failed.
...
+
link:locating-sgf6212-in-data-center.html[Locate controller in data center]

.About this task

The appliance Storage Node will not be accessible when you replace the SG6200-CN controller. If the SG6200-CN controller is functioning sufficiently, you can perform a controlled shutdown at the start of this procedure.
...
. If the SG6200-CN controller is functioning sufficiently to allow for a controlled shutdown, link:power-sgf6212-off-on.html[shut down the SG6200-CN controller].
...
. Remove and replace the SG6200-CN controller:
