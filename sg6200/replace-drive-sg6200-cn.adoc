...
summary: 'The SG6260 appliance contains two SSD drives in the SG6200-CN controller which function as a read cache. If one of these drives fails, you must replace it as soon as possible to minimize the potential performance impact.'
---
= Replace drive in SG6200-CN
:icons: font
:imagesdir: ../media/

[.lead]
The SG6260 appliance contains two SSD drives in the SG6200-CN controller which function as a read cache. If one of these drives fails, you must replace it as soon as possible to minimize the potential performance impact.
...
+
image::../media/sg6260_front_with_ssds.png["SSD location in SG6260"] 
