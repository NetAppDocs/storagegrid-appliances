...
[.lead]
The SGF6212 storage appliance contains 12 SSD drives. Data on the drives is protected by a RAID scheme that enables the appliance to recover from any single drive failure without having to copy data from another node. 
...
+
*Illustration of drive removal. Callout one (1) shows user pressing the release button on the drive. An arrow shows the drive handle swinging in and out. Callout two (2) shows an arrow with the drive moving out of the appliance.*
+
