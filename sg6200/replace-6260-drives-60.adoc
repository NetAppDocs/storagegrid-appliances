...
---
= Replace drive in storage controller shelf or expansion shelf (SG6260)
:icons: font
:imagesdir: ../media/

[.lead]
You can replace a drive in an SG6260 storage controller shelf or expansion shelf (DE460C).
