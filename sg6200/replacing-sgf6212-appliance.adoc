...
* You have link:locating-sgf6212-in-data-center.html[physically located the appliance].
...
. link:power-sgf6212-off-on.html#shut-down-the-sgf6212-appliance-or-sg6200-cn-controller[Shut down the appliance].
...
NOTE: To prevent degraded performance, don't twist, fold, pinch, or step on the cables.
 ...
 .. link:reinstalling-sgf6212-into-cabinet-or-rack.html[Remove the failed appliance from the cabinet or rack].
...
+
image::../media/sgf6212_ssds_locations.png["Fan locations"] 
+
[options="header"]
|===
|| Drive  
...
CAUTION: If you wish to retain the data on the drives, be sure to insert the SSD drives into the same drive slots they occupied in the failed appliance. If you don't, the Appliance Installer will display a warning message and you will have to put the drives into the correct slots and reboot the appliance before the appliance can rejoin the grid.  
 .. link:reinstalling-sgf6212-into-cabinet-or-rack.html[Install the replacement appliance into the cabinet or rack].
...
* link:../installconfig/troubleshooting-hardware-installation-sg6200.html#view-boot-codes[View boot-up codes for appliance]
