...
* You have link:locating-sgf6212-in-data-center.html[physically located the SG6200-CN controller] where you are replacing the NIC in the data center.
+
NOTE: Hot-swapping is *not* supported for this procedure. A link:power-sgf6212-off-on.html#shut-down-the-sgf6212-appliance-or-sg6200-cn-controller[controlled shutdown of the appliance] is required before disconnecting cables and removing the NIC.
