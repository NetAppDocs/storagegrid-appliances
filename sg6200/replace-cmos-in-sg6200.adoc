...
* You have link:locating-sgf6212-in-data-center.html[physically located the SGF6212 appliance or SG6200-CN controller] where you are replacing the CMOS battery in the data center.
