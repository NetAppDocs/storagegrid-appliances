...
---
= Upgrade SG6200 drive firmware using SANtricity System Manager using offline method (SG6260)
:icons: font
:imagesdir: ../media/
...
NOTE: This procedure does *not* apply to the NVMe SSDs in the SG6200-CN, which are updated during StorageGRID software upgrades. Only drives in the E4000 can be updated using this procedure. 
