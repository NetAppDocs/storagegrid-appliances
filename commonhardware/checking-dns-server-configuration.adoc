...
---
= Check the DNS server configuration for a StorageGRID appliance
:icons: font
:imagesdir: ../media/
...
+
NOTE: Changes made to the DNS settings are temporary and are lost when you exit maintenance mode.
