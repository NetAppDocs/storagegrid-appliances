...
Access the Change IP tool and update the MTU settings as described in https://docs.netapp.com/us-en/storagegrid-118/maintain/changing-nodes-network-configuration.html[Change node network configuration^].
