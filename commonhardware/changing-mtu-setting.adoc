...
---
= Change the MTU setting for a StorageGRID appliance
:icons: font
:imagesdir: ../media/
...
Access the Change IP tool and update the MTU settings as described in https://docs.netapp.com/us-en/storagegrid/maintain/changing-nodes-network-configuration.html[Change node network configuration^].
