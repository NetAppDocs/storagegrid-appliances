...
Access the Change IP tool and update the MTU settings as described in https://review.docs.netapp.com/us-en/storagegrid-118_main/maintain/changing-nodes-network-configuration.html[Change node network configuration^].
