...
* For Storage Node appliances, the source node appliance and the target appliance don't need to be the same appliance model; however, the target appliance must have greater storage capacity than the source appliance.
+
