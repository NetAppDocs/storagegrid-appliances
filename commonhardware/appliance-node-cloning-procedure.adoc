...
. https://review.docs.netapp.com/us-en/storagegrid-118_main/maintain/placing-appliance-into-maintenance-mode.html[Place the source node you are cloning into maintenance mode^].
