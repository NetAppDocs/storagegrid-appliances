...
sidebar: sidebar
keywords: sgf6112, sg110, sg1100, sg6160, sg6200, sgf6212 manage drives tab, locate drive, fail drive, logically replace drive
...
---
= Use the Manage drives tab (SG110, SG1100, SG6100, and SG6200)
:icons: font
:imagesdir: ../media/
