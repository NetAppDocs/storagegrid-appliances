...
You can successfully clone an SG5860 as the source or the target with some restrictions.
...
You can successfully clone an SG6160 as the source or the target with some restrictions.
