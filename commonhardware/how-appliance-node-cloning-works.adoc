...
You can successfully clone an SG5860 as the source or the target with some restrictions (listed by source).
...
You can successfully clone an SG6160 as the source or the target with some restrictions (listed by source).
