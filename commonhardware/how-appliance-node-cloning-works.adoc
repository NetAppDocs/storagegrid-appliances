 ...
 ** You can clone an SG110 source node appliance to an SG1100 services target appliance, or an SG100 source node appliance to an SG1000 services target appliance, to give the Admin Node or Gateway Node greater capability.
 ** You can clone an SG1100 source node appliance to an SG110 services target appliance, or an SG1000 source node appliance to an SG100 services target appliance, to redeploy the SG1100 or SG1000 for a more demanding application.
+
