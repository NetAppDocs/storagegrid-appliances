...
=== SG6260 appliance cloning information and restrictions

You can successfully clone an SG6260 appliance as the source or the target with some restrictions (listed in the appliance cloning information and restrictions for each source).
