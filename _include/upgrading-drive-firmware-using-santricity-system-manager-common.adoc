...
* If you are performing an offline upgrade, you have https://review.docs.netapp.com/us-en/storagegrid-118_main/maintain/placing-appliance-into-maintenance-mode.html[placed the StorageGRID appliance into maintenance mode^].
+
...
. If you are performing an offline upgrade, confirm that the appliance is in https://review.docs.netapp.com/us-en/storagegrid-118_main/maintain/placing-appliance-into-maintenance-mode.html[maintenance mode^].
