...
IMPORTANT: There are two types of drives: SSD and HDD. You must use the offline method to upgrade the firmware on SSDs. You can use either the online or offline method to upgrade the firmware on HDDs.
...
+
IMPORTANT: You must use the offline method when upgrading SSD drives.
