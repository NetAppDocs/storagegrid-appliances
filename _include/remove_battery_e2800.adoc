...
+
CAUTION: *Possible hardware damage* -- The metal flange at the front of the battery must be completely inserted into the slot on the controller (as shown in the first figure). If the battery isn't installed correctly (as shown in the second figure), the metal flange might contact the controller board, causing damage.
...
image::../media/e2800_battery_flange_ok.gif["Battery Flange Correct"] 
  ...
  *** *Incorrect -- The battery's metal flange isn't inserted into the slot on the controller:*
+
