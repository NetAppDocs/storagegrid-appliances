// Replace CMOS batteries in SG6200-CN, SGF6212, SG120, SG1200
...
+
image:../media/drw_s2025_cmos_battery_replace_ieops-2558.svg[Removing a CMOS battery from the system board]
