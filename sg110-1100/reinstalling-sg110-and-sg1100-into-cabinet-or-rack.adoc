...
= Relocate an SG110 and SG1100 in a cabinet or rack
:icons: font
:imagesdir: ../media/
...
* You have link:power-sg110-and-sg1100-off-on.html#shut-down-the-sg110-or-sg1100-appliance[shut down the SG110 or SG1100].
+
...
link:power-sg110-and-sg1100-off-on.html#power-on-sg110-or-sg1100-and-verify-operation[Restart the appliance].
