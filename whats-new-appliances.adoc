...
TIP: Go to https://docs.netapp.com/us-en/storagegrid-11.7/upgrade/whats-new.html[What's new in StorageGRID 11.7^] to learn about the new features in StorageGRID 11.7.
