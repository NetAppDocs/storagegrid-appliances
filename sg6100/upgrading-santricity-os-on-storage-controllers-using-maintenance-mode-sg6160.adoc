...
---
= Upgrade the SANtricity OS on SG6160 storage controllers using maintenance mode
:icons: font
:imagesdir: ../media/
...
* You must place the SG6160 controller into link:../commonhardware/placing-appliance-into-maintenance-mode.html[maintenance mode], which stops all I/O to the E4000 storage controllers.
+
