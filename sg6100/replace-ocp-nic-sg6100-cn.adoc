...
---
= Replace an external NIC in an SG6100-CN
:icons: font
:imagesdir: ../media/
...
+
NOTE: Hot-swapping is *not* supported for this procedure. A link:power-sgf6112-off-on.html#shut-down-the-sgf6112-appliance-or-sg6100-cn-controller[controlled shutdown of the appliance] is required before disconnecting cables and removing the NIC.
