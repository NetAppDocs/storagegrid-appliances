...
The appliance Storage Node will not be accessible when you replace the SG6100-CN controller. If the SG6000-CN controller is functioning sufficiently, you can perform a controlled shutdown at the start of this procedure.
...
. If the SG6100-CN controller is functioning sufficiently to allow for a controlled shutdown, link:power-sg6100-cn-controller-off-on.html#shut-down-sg6100-cn-controller[shut down the SG6100-CN controller].
...
link:../installconfig/sg6000-cn-installing-into-cabinet-or-rack.html[Install SG6100-CN into cabinet or rack]

link:../installconfig/viewing-status-indicators.html[View status indicators]

link:../installconfig/troubleshooting-hardware-installation.html#view-boot-codes[View boot-up codes for SG6100-CN controller]
