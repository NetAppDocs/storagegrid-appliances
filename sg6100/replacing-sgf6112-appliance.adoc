...
* You have a replacement appliance with the same part number as the appliance you are replacing. Check the tags attached to the front of the appliances to confirm that the part numbers match.
...
. link:power-sgf6112-off-on.html#shut-down-the-sgf6112-appliance-or-sg6100-cn-controller[Shut down the appliance].
...
NOTE: To prevent degraded performance, don't twist, fold, pinch, or step on the cables.
 ...
 .. link:reinstalling-sgf6112-into-cabinet-or-rack.html[Remove the failed appliance from the cabinet or rack].
 .. Note the position of the replaceable components (two power supplies, three NICs, and twelve SSDs) in the failed appliance.
+
...
+
CAUTION: If you want to retain the data on the drives, insert the SSD drives into the same drive slots they occupied in the failed appliance. If you don't, the Appliance Installer will display a warning and you will have to put the drives into the correct slots and reboot the appliance before the appliance can rejoin the grid.  
 .. link:reinstalling-sgf6112-into-cabinet-or-rack.html[Install the replacement appliance into the cabinet or rack].
 .. Replace the cables and any optical transceivers.

 . Power on the appliance. 
 
 . If the appliance you replaced had hardware drive encryption enabled for the SED drives, see link:../installconfig/optional-enabling-node-encryption.html#access-an-encrypted-drive[Access an encrypted drive]. Follow the guidance to access the encrypted drive when the replacement appliance starts for the first time. A reboot will be required to complete the procedure.
...
* link:../installconfig/troubleshooting-hardware-installation-sg6100.html#view-boot-codes[View boot-up codes for appliance]

// 2023 DEC 21, SGRIDDOC-30
// 2023 OCT 11, SGRIDDOC-12
// 2024 SEP 30, SGRIDDOC-103
