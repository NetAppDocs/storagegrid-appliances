...
---
= Relocate an SGF6112 or SG6100-CN in a cabinet or rack
:icons: font
:imagesdir: ../media/
...
* You have link:power-sgf6112-off-on.html#shut-down-the-sgf6112-appliance-or-sg6100-cn-controller[shut down the SGF6112 or SG6100-CN].
+
...
link:power-sgf6112-off-on.html#power-on-sgf6112-or-sg6100-cn-and-verify-operation[Restart the appliance].
