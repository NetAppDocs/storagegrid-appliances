...
* You have link:locating-sgf6112-in-data-center.html[physically located the SGF6112] where you are performing maintenance in the data center.

* You have link:power-sgf6112-off-on.html#shut-down-the-sgf6112-appliance[shut down the SGF6112].
+
