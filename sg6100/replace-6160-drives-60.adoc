...
summary: Replace a drive in an SG6160 with a 60-drive shelf.
---
= Replace drive in SG6160 (60-drive shelf)
:icons: font
:imagesdir: ../media/

[.lead]
You can replace a drive in a SG6160 with a 60-drive shelf.
