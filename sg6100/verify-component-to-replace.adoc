...
+
To help you locate the appliance in the data center, you can use the BMC IP address to link:turning-sgf6112-identify-led-on-and-off.html[turn on the appliance identify LED].