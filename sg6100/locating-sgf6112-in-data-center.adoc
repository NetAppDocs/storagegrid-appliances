...
---
= Locate an SGF6112 appliance or SG6100-CN controller in a data center
:icons: font
:imagesdir: ../media/
...
link:turning-sgf6112-identify-led-on-and-off.html[Turn off the blue identify LED] using one of the following methods if you used it to locate the appliance:
