...
= Power SG120 or SG1200 off and on
:icons: font
:imagesdir: ../media/

[.lead]
You can shut down the SG120 or SG1200 appliance and power it back on to perform maintenance.
...
* You have link:reinstalling-sg120-and-sg1200-into-cabinet-or-rack.html[installed the controller in a cabinet or rack] and connected the data and power cables.

* You have link:locating-sg120-and-sg1200-in-data-center.html[physically located the controller in the data center].
