---
permalink: sg120-1100/replacing-drive-in-sg120-and-sg1200.html
sidebar: sidebar
...
[.lead]
The SG120 and SG1200 services appliances contains two SSD drives. The drives are mirrored using RAID1 for redundancy. If one of the drives fails, you must replace it as soon as possible to ensure redundancy. 
...
+
image::../media/sg1200_front_with_ssds.png["SG120 and SG1200 drive locations"] 
