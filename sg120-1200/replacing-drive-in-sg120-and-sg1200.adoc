...
summary: 'The SG120 and SG1200 services appliances contains two SSD drives. The drives are mirrored using RAID1 for redundancy. If one of the drives fails, you must replace it as soon as possible to ensure redundancy.'
---

= Replace drives in the SG120 or SG1200
:icons: font
:imagesdir: ../media/

[.lead]
The SG120 and SG1200 services appliances contain two SSD drives. The drives are mirrored using RAID1 for redundancy. If one of the drives fails, you must replace it as soon as possible to ensure redundancy. 

// Similar procedure for SG6200 - unable to use includes due to differences in configuration, not operation.
...
+
image::../media/sg120_sg1200_front_with_ssds.png["SG120 and SG1200 drive locations"] 
...
+
NOTE: Verify the tray handle is fully open before you attempt to remove the drive.
