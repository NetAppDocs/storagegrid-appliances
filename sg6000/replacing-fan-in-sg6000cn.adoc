...
storagegrid, sg6000-cn, storage node, storage appliance, replacing, replace, fan, remove, removing, removal, install, installing, installation
...
. link:power-sg6000-cn-controller-off-on.html#:#power=on=sg6000-cn-controller-and-verify-operation[Power on the SG6000-CN controller].
