...
---
= Learn about upgrading the SANtricity OS on SG6000 storage controllers
:icons: font
:imagesdir: ../media/
...
CAUTION: When upgrading the SANtricity OS for your storage appliance, you must follow the instructions in the StorageGRID documentation. If you use any other instructions, your appliance could become inoperable.
