...
---
= Add an expansion shelf to a deployed SG6060 appliance
:icons: font
:imagesdir: ../media/
...
* You have the expansion shelf and four SAS cables for each expansion shelf.
...
+
Examples of the messages that could appear on the Home page, depending on the number of existing or new expansion shelves:
...
// 2025 DEC 10, storagegrid-appliances-issue-44