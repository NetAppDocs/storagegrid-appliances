...
---
= Replace hardware components in the SG6000 storage controller shelf
:icons: font
:imagesdir: ../media/
...
For instructions for the other field replaceable units (FRUs) in the controller shelves, access the https://docs.netapp.com/us-en/e-series-family/index.html[E-Series procedures for system maintenance^].
