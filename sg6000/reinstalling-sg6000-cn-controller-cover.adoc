...
---
= Replace the SG6000-CN controller cover
:icons: font
:imagesdir: ../media/
...
+
CAUTION: Wrap the strap end of an ESD wristband around your wrist and secure the clip end to a metal ground to prevent static discharge when working inside the SG6000-CN controller.
