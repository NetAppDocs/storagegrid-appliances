...
The appliance Storage Node may not be accessible when you replace the controller. If the E4000 series controller is functioning sufficiently, you can https://docs.netapp.com/us-en/storagegrid-appliances/commonhardware/placing-appliance-into-maintenance-mode.html[place the SG5800 controller into maintenance mode].
