...
summary: 
---
= Change link configuration of 5800SG controller
:icons: font
:imagesdir: ../media/

[.lead]
You can change the Ethernet link configuration of the 5800SG controller. You can change the port bond mode, the network bond mode, and the link speed.

.Before you begin

link:../commonhardware/placing-appliance-into-maintenance-mode.html[Place 5800SG controller into maintenance mode]. 
...
Options for changing the Ethernet link configuration of the 5800SG controller include:
...
`*https://_5800SG_Controller_IP_:8443*`
+
