...
[.lead]
For storage controllers currently using SANtricity OS 08.42.20.00 (11.42) or newer, you can use the Grid Manager to apply an upgrade. You can also link:upgrading-santricity-os-on-storage-controller.html[use maintenance mode to apply an upgrade].
