...
summary: 
---
= Replace 5800SG controller
:icons: font
:imagesdir: ../media/

[.lead]
You might need to replace the 5800SG controller if it is not functioning optimally or if it has failed.
...
The appliance Storage Node will not be accessible when you replace the controller. If the 5800SG controller is functioning sufficiently, you can perform a controlled shutdown at the start of this procedure.
...
. Shut down the 5800SG controller.
