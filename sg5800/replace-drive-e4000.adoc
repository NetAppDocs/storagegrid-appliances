...
---
= SG5800 drive replacement requirements
:icons: font
:imagesdir: ../media/


[.lead]
Before you replace a drive in an SG5812 or SG5860, review the requirements and considerations. 

== Drive handling

The drives in your appliance are fragile. Improper drive handling is a leading cause of drive failure.
