...
summary: You can replace a power supply in the SG5812.
---
= Replace a power supply in the SG5812 StorageGRID appliance
:icons: font
:imagesdir: ../media/

[.lead]
You can replace a power supply in an SG5812.

.About this task

If you plan to replace a power supply, keep the following requirements in mind.

* You must have a replacement power supply that is supported for your appliance.
...
** A replacement power supply that is supported for your controller appliance model.
...
Prepare to replace a power supply.
