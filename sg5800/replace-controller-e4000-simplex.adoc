...
---
= Replace the E4000 controller in an SG5800
:icons: font
:imagesdir: ../media/
...
** From Grid Manager, select *Nodes* > *_appliance node_* > *SANtricity System Manager*. Controller information is on the https://docs.netapp.com/us-en/storagegrid/monitor/viewing-santricity-system-manager-tab.html[SANtricity System Manager tab^].
