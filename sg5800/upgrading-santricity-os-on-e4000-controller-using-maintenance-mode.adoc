...
* You must place the 5800SG controller into link:../commonhardware/placing-appliance-into-maintenance-mode.html[maintenance mode], which interrupts the connection to the E4000 controller.
+
