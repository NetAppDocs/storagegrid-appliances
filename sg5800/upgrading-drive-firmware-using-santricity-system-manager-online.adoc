...
---
= Upgrade SG5800 StorageGRID appliance drive firmware using the SANtricity System Manager online method
:icons: font
:imagesdir: ../media/
...
[NOTE]
====
Drives belonging to volumes that don't have redundancy must be updated using the link:upgrading-drive-firmware-using-santricity-system-manager-offline.html[offline method].
====
