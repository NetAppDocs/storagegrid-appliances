...
---
= StorageGRID SG6100 appliance components
:icons: font
:imagesdir: ../media/
...
* 4 × 10/25 GbE Ethernet ports for Grid/Client network traffic (or up 4 x 100 GbE with optional 100G NIC SKU)
...
This figure shows the location of the power supply and identify LEDs on the rear of the SG6100-CN compute controller. Additional status and activity LEDs are on the appliance ports. These LEDs might vary by appliance model.

image::../media/q2023_rear_leds.png["Rear LEDs SG6100-CN"] 
