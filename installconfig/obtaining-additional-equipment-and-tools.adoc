...
---
= Obtain additional equipment and tools for StorageGRID appliances
:icons: font
:imagesdir: ../media/
...
.SG120 and SG1200
--
You need the following additional equipment to install and configure the SG120 and SG1200 hardware.
...
*** 40-GbE QSFP+
*** 100-GbE QSFP28
*** 200-GbE QSFP56 (200GbE NIC only)
...
** 40-GbE QSFP+
** 100-GbE QSFP28
** 200-GbE QSFP56 (200 GbE NIC only)
