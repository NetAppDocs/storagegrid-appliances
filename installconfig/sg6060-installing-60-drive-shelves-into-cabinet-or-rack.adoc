...
---
= Install the 60-drive shelves for an SG6060
:icons: font
:imagesdir: ../media/
...
NOTE: Before committing to the installation, verify that the 0.5m optic cables shipped with the appliance, or cables that you supply, are long enough for the planned layout.
