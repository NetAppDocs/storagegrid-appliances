...
* link:../sg110-1100/changing-link-configuration-of-sg110-and-sg1100-appliance.html[Change link configuration of the SG110 or SG1100 services appliance]
...
. To configure the Grid Network, select either *Static* or *DHCP* in the *Grid Network* section of the page and then enter your network settings.
+
[role="tabbed-block"]
====
...
+
NOTE: If the Client Network is not enabled, the default route will use the Grid Network gateway.
...
. To configure the Admin Network, select either *Static* or *DHCP* in the *Admin Network* section of the page and then enter your network settings.
+
...
+
See link:../installconfig/cabling-appliance.html[Cable appliance] for the Management Port 1 location on your appliance.
...
. To configure the Client Network, select either *Static*, *DHCP*, or *None* in the *Client Network* section of the page and then enter your network settings.
+
NOTE: To configure the Client Network, make sure that the Client Network is enabled on the Link Configuration page.
+
NOTE: You can select *None* only if VLAN tags are used for the Client Network.
+
[role="tabbed-block"]
====
...
.None
--
If VLAN tags are used for the Client Network, you can select *None* to enable the Client Network without specifying an IP address. The Client Network will then use the IP address already assigned to the VLAN, saving an IP address from your block for other use.
--
====
