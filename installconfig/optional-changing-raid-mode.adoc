...
---
= Change the RAID mode for an SG5760, SG5860, SG6000, SG6160, or SG6260
:icons: font
:imagesdir: ../media/
...
You can change the RAID mode on the following appliances:
...
** DDP provides drawer-loss protection in SG5760, SG5860, SG6160, and SG6260 appliances.
+
