...
summary: "You can access the BMC interface using the DHCP or static IP address for the BMC management port on some appliance models."
---
= Access the BMC interface on a StorageGRID appliance
:icons: font
:imagesdir: ../media/
