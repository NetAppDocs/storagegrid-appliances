...
summary: 'You install a set of rails for the SG6200-CN controller in your cabinet or rack, and then slide the controller onto the rails.'
---
= Install the SG6200-CN controller for an SG6260
:icons: font
:imagesdir: ../media/

[.lead]
You install a set of rails for the SG6200-CN controller in your cabinet or rack, and then slide the controller onto the rails.
...
+
image::../media/rails_extended_out.gif["SG6200 Rails"] 

. Insert the SG6200-CN controller into the rails.
...
+
image::../media/sg6000_cn_rails_blue_button.gif["SG6200 Sliding on Rails"] 
+
...
+
image::../media/s25_rack_retaining_screws.png["SG6260 rack retaining screws"] 
