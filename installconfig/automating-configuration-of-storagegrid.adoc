...
NOTE: You can also configure the system using the https://review.docs.netapp.com/us-en/storagegrid-118_main/primer/exploring-grid-manager.html[Grid Manager^] or the link:overview-of-installation-rest-apis.html[Installation API].
