...
---
= StorageGRID appliance network types
:icons: font
:imagesdir: ../media/
...
* link:gathering-installation-information-sg120-and-sg1200.html[SG120 and SG1200]
...
* *Management network for SANtricity* (optional for storage appliances, not needed for the SGF6112 and SGF6212): This network provides access to SANtricity System Manager, allowing you to monitor and manage the hardware components in the appliance and storage controller shelf. This management network can be the same as the Admin Network for StorageGRID, or it can be an independent management network.

* *BMC management network* (optional for SG6000, SG6100, SG6200, and services appliances): This network provides access to the baseboard management controller in the SG6000, SG6100, SG6200, and services appliances allowing you to monitor and manage the hardware components in the appliance. This management network can be the same as the Admin Network for StorageGRID, or it can be an independent management network.
+
...
NOTE: For detailed information about StorageGRID networks, see the https://docs.netapp.com/us-en/storagegrid/network/storagegrid-network-types.html[StorageGRID network types^].
