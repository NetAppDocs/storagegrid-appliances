...
---
= Set the BMC management port IP address on a StorageGRID appliance
:icons: font
:imagesdir: ../media/
...
. In the LAN IP Settings, make a note of the IPv4 address that is automatically displayed.
+
