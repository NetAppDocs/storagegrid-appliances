...
Additionally, you can test connectivity on the Admin and Client Networks and on UDP ports, such as those used for external NFS or DNS servers. For a list of these ports, see the https://review.docs.netapp.com/us-en/storagegrid-118_main/network/network-port-reference.html[network port reference^].
