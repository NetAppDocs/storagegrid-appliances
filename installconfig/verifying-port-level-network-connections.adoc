...
+
For example, to probe the gateway on the network or the primary Admin Node, specify a range using a hyphen.
+
In this example, to scan all IPs between 172.16.1.5 and 172.16.1.10, enter 172.16.1.5-10. Ranges are limited to the last two octets.
