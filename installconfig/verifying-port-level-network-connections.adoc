...
---
= Verify port-level network connections on StorageGRID appliances
:icons: font
:imagesdir: ../media/
...
. Specify a space-separated list or a range of IPv4 addresses for the hosts on that network.
