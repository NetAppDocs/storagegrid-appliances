...
+
NOTE: Before committing to the installation, verify that the 0.5m optic cables shipped with an SG6000 or SG6100 appliance, or cables that you supply, are long enough for the planned layout.
