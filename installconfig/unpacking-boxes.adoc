...
image::../media/fc_cable_and_sfp.gif[Optical cables and SFPs]
+
** Two optical cables for the iSCSI interconnect ports
** Four SFP+ transceivers and four SFP28 transceivers, compatible with both the four 25-GbE iSCSI interconnect ports and the four 10-GbE network ports
