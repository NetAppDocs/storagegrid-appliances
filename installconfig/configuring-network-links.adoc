...
---
= Configure network links for a StorageGRID appliance
:icons: font
:imagesdir: ../media/
...
* link:gathering-installation-information-sg120-and-sg1200.html#port-bond-modes[Port bond modes (SG1200 and SG120)]
...
* link:gathering-installation-information-sg6200.html#port-bond-modes[Port bond modes (SGF6212 and SG6200-CN)]
...
Fixed port bond mode (default)::
+
The figures show how the four network ports on the SG120 and SG1200 are bonded in fixed port bond mode (default configuration).
+
SG120:
+
image::../media/sg120_fixed_port.png["SG120 Fixed Port Bond Mode"] 
+
SG1200:
+
image::../media/sg1200_fixed_port.png["SG1200 Fixed Port Bond Mode"] 
+
[cols="1a,3a" options="header"]
|===
| Callout| Which ports are bonded
...
SG120:
+
image::../media/sg120_aggregate_ports.png["SG120 Aggregate Port Bond Mode"] 
+
SG1200:
+
image::../media/sg1200_aggregate_ports.png["SG1200Aggregate Port Bond Mode"] 
+
[cols="1a,3a" options="header"]
|===
| Callout| Which ports are bonded
...
SG120:
+
image::../media/sg120_bonded_management_ports.png["Admin Network Ports Bonded SG120"] 
+
SG1200:
+
image::../media/sg1200_bonded_management_ports.png["Admin Network Ports Bonded SG1200"] 
--
...
*SGF6212*:
+
image::../media/sgf6212_fixed_port.png["SGF6212 Fixed Port Bond Mode"] 
+
*SG6200-CN*:
+
image::../media/sg6200_cn_fixed_port.png["SG6200-CN Fixed Port Bond Mode"] 
+
[cols="1a,3a" options="header"]
|===
| Callout| Which ports are bonded
...
*SGF6212*:
+
image::../media/sgf6212_aggregate_ports.png["SGF6212 Aggregate Port Bond Mode "] 
+
*SG6200*:
+
image::../media/sg6200_cn_aggregate_ports.png["SG6200-CN Aggregate Port Bond Mode "] 
+
[cols="1a,3a" options="header"]
|===
| Callout| Which ports are bonded
...
*SGF6212*:
+
image::../media/sgf6212_bonded_management_ports.png["Admin Network Ports Bonded SGF6212"] 
+
*SG6200*:
+
image::../media/sg6200_cn_bonded_management_ports.png["Admin Network Ports Bonded SG6200-CN"] 
...
+
NOTE: For the SG5800, the link state for port 1 is unavailable in software and must be physically verified using the status LED on the SG5800 controller.
+
...
+
If you plan to use the 25-GbE link speed for the SG6200, SG6100, SG6000, SG5800, or SG5700 network ports:
 ...
 ** For the SG5800, SG6000, SG6100, or SG6200, select *Auto* from the *Link speed* drop-down list.
