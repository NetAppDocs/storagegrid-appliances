...
+
NOTE: For the SG5800, the link state for port 1 must be physically verified using the status LED on the E4000 controller.
+
...
+
NOTE: For the SG5800, clear the *Enable network* checkbox for the Client Network and then re-select it before changing the port bond mode.
+
