...
+
NOTE: If you use Admin Nodes and Gateway Nodes in the same HA group, Admin Node-only port will not fail over. See the instructions for https://review.docs.netapp.com/us-en/storagegrid-118_main/admin/configure-high-availability-group.html[configuring HA groups^].
