...
2
a|
5800SG controller (compute controller)
a|
3
a|
Power-fan canisters
...
Both the 12-drive SG5812 and the 60-drive SG5860 models of the StorageGRID appliance include an 5800SG compute controller and an E-Series E4000 storage controller. 


=== 5800SG compute controller
...
image::../media/e5800sg_controller_with_callouts.png[Connectors on 5800SG controller]
...
| 25GbE iSCSI
| Connect the 5800SG controller to the E4000 controller.
...
* Connects to the 5800SG controller and operates as the target.
...
| Interconnect ports 1 and 2
| 25GbE iSCSI
| Connect the E4000 controller to the 5800SG controller.
