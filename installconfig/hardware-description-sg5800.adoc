...
image::../media/sg5760_front_and_back_views.gif[Front and back of the SG5860 appliance]

=== SG5860 components

The SG5860 includes two controllers, two fan canisters, and two power canisters.

image::../media/sg5760_with_callouts.gif[Controllers, fan canisters, and power canisters in SG5860 appliance]
...
Both the 12-drive SG5812 and the 60-drive SG5860 models of the StorageGRID appliance include an E5800SG compute controller and an E-Series E4000 storage controller. 
