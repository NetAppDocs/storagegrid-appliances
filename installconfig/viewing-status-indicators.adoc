...
---
= View status indicators and codes on StorageGRID appliances
:icons: font
:imagesdir: ../media/
...
The following figure shows the location of the power supply and identify LEDs on the rear of the SG100 and the SG1000. Additional status and activity LEDs are on the appliance ports. These LEDs might vary by appliance model.
...
The following figure shows the location of the power supply and identify LEDs on the rear of the SG110 and the SG1100. Additional status and activity LEDs are on the appliance ports. These LEDs might vary by appliance model.
...
* <<appliance_indicators_sg120_sg1200,Appliance indicators and buttons>>
* <<general_boot_codes_sg120_sg1200,General boot-up codes>>
* <<ssd_indicators_sg120_sg1200,SSD indicators>>

Use this information to help link:troubleshooting-hardware-installation-sg120-and-sg1200.html[troubleshoot SG120 and SG1200 hardware installation].

[[appliance_indicators_sg120_sg1200]]
Appliance indicators and buttons::
+
The following figure shows indicators and buttons on the front of the SG120 and SG1200 appliances.
+
image::../media/sg120_sg1200_front_indicators.png["Front Indicators - SG120 and SG1200"] 
+
[cols="1a,2a,3a" options="header"]
|===
| Callout | Display| State
...
| 5
| PFR
| This light is not used by the SG120 and SG1200 appliances and remains off.

|===


The following figure shows the location of the power supply and identify LEDs on the rear of the SG120 and the SG1200. Additional status and activity LEDs are on the appliance ports. These LEDs might vary by appliance model.
...
SSD indicators::
+
The following figure shows SSD indicators on the SG120 and SG1200 appliances.
+
image::../media/ssd_indicators.png["SSD Indicators"] 
+
[cols="1a,2a,2a" options="header"]
...
The following figure shows the location of the power supply and identify LEDs on the rear of the SG6000-CN controller. Additional status and activity LEDs are on the appliance ports. These LEDs might vary by appliance model.
...
The following figure shows the location of the power supply and identify LEDs on the rear of the SGF6112 and SG6100-CN. Additional status and activity LEDs are on the appliance ports. These LEDs might vary by appliance model.

image::../media/q2024_rear_leds.png["Rear LEDs SGF6112 and SG6100-CN"] 
...
* <<appliance_indicators_SG6200,Appliance indicators and buttons>>
* <<general_boot_codes_SG6200,General boot-up codes>>
* <<ssd_indicators_SG6200,SSD indicators>>

Use this information to help link:troubleshooting-hardware-installation-sg6200.html[troubleshoot SG6200 hardware installation].

[[appliance_indicators_SG6200]]
Appliance indicators and buttons::
+
The following figure shows indicators and buttons on the front of the SG6200 appliances.

+
image::../media/s25_front_indicators.png["Front Indicators - SG6200"] 
+
[cols="1a,2a,3a" options="header"]
|===
| Callout | Display| State
...
| 5
| PFR
| This light is not used by SG6200 appliances and remains off. 

|===

The following figure shows the location of the power supply and identify LEDs on the rear of the SGF6212 and SG6200-CN. Additional status and activity LEDs are on the appliance ports. These LEDs might vary by appliance model.

image::../media/s25_rear_leds.png["Rear LEDs SGF6212 and SG6200-CN"] 
...
SSD indicators::
+
The following figure shows SSD indicators on the SGF6212 or SG6260 appliance.
+
image::../media/ssd_indicators.png["SSD Indicators"] 
+
[cols="1a,2a,2a" options="header"]
...
*Note:* If a new working SSD is inserted into a working SGF6212 or SG6260 StorageGRID node, the LEDs on the SSD should blink initially, but stop blinking as soon as the system determines that the drive has enough capacity and is functional.
...
// 2025 DEC 11, storagegrid-appliances-issue-53