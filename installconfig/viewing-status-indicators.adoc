...
* <<status_indicators_5800sg_controller,Status indicators on 5800SG controller>>
* <<general_boot_codes_sg5800,General boot-up codes>>
* <<boot_codes_5800sg_controller,5800SG controller boot-up codes>>
* <<error_codes_5800sg_controller,5800SG controller error codes>>

Use this information to help link:troubleshooting-hardware-installation.html[troubleshoot SG5800 hardware installation].


[[status_indicators_5800sg_controller]]
Status indicators on 5800SG controller::
+
After the StorageGRID Appliance Installer has started, you should periodically review the status indicators on the 5800SG controller.
+
The following figure shows status indicators on the 5800SG controller.
+
image::../media/e5800sg_leds.png[Status indicators on 5800SG controller]
+
[cols="1a,2a,2a" options="header"]
|===
| Callout | Display| Description
