...
Boot-up status codes for SG6010 storage controllers::
+
...
* link:../sg6100/power-sg6100-cn-controller-off-on.html#power-on-sg6100-cn-controller-and-verify-operation[Power on SG6100-CN controller and verify operation]
