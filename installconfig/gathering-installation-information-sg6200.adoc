...
---
= Gather network information for the SG6200
:icons: font
:imagesdir: ../media/
...
Before installing an SGF6212 or SG6260 appliance, confirm your StorageGRID system is using a required version of StorageGRID software.
...
You connect both of the storage controllers in the SG6260 appliance to the management network you will use for SANtricity System Manager. Controller A is on the top and controller B is on the bottom.
...
RJ-45 ports on the SGF6212 appliance:

image::../media/sgf6212_rj_45_ports.png["SGF6212 RJ-45 ports"] 

RJ-45 ports on the SG6200-CN controller:

image::../media/sg6200_cn_rj_45_ports.png["SG6200-CN RJ-45 ports"] 
...
The following figures show the BMC management port on the SGF6212 and SG6200-CN.
...
When link:configuring-network-links.html[configuring network links] for the SGF6212 appliance, you can use port bonding for the ports that connect to the Grid Network and optional Client Network, and the 1/10-GbE management ports that connect to the optional Admin Network. Port bonding helps protect your data by providing redundant paths between StorageGRID networks and the appliance.
...
image::../media/sgf6212_bonded_management_ports.png["SGF6212 Network Management Ports"] 

_SG6200-CN:_

image::../media/sg6200_cn_bonded_management_ports.png["SG6200-CN Network Management Ports"] 
