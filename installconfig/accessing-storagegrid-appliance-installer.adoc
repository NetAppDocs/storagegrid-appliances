...
.E5800SG
--
Connect the service laptop to  management port 1 on the E5800SG controller, using an Ethernet cable.

image::../media/e5800sg_mgmt_port.png[Location of Management Port 2 on the E5800SG controller]
--
