...
---
= Configure SANtricity System Manager (SG6000, SG6100, SG5700, and SG5800)
:icons: font
:imagesdir: ../media/
...
* You are using a https://review.docs.netapp.com/us-en/storagegrid-118_main/admin/web-browser-requirements.html[supported web browser^].
...
+
For specific instructions on configuring a StorageGRID proxy for sending E-Series AutoSupport messages without using the management port, go to the https://review.docs.netapp.com/us-en/storagegrid-118_main/admin/configuring-storage-proxy-settings.html[instructions for configuring storage proxy settings^].
