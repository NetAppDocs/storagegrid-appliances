...
. https://docs.netapp.com/us-en/storagegrid-appliances/installconfig/deploying-appliance-storage-node.html[Start installation] of the appliance.
...
. link:./https://docs.netapp.com/us-en/storagegrid-appliances/installconfig/optional-enabling-node-encryption.html#drive-encryption[Enable Drive Encryption] for SED SSDs installed in the SG6100-CN compute node. 
