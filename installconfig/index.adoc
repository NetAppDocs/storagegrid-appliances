...
---
= Quick start for StorageGRID appliance installation
:icons: font
:imagesdir: ../media/
...
. https://docs.netapp.com/us-en/storagegrid/admin/web-browser-requirements.html[Review web browser requirements^]
...
** link:installing-appliance-in-cabinet-or-rack-sg120-and-sg1200.html[SG120 and SG1200]
...
. link:accessing-and-configuring-santricity-system-manager.html[Access and configure SANtricity System Manager] (SG6260, SG6160, SG5700, SG5800, and SG6000)

. link:configuring-bmc-interface.html[Configure the BMC interface] (SG6200, SG6100, SG6000, and services appliances)

. Perform optional setup steps
** link:optional-enabling-node-encryption.html[Enable node or drive encryption]
** link:optional-changing-raid-mode.html[Change RAID mode] (SG6260, SG6160, SG6000, SG5860, and SG5760)
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png["Five"]  Configuration

[role="quick-margin-para"]
When all nodes have been deployed, use the Grid Manager to link:https://docs.netapp.com/us-en/storagegrid/swnodes/navigating-to-grid-manager.html[configure the grid and complete the installation^].