...
** link:sg6160-installing-60-drive-shelves-into-cabinet-or-rack.html[SG6160]
...
. link:accessing-and-configuring-santricity-system-manager.html[Access and configure SANtricity System Manager] (SG6160, SG6000, SG5800, and SG5700)
