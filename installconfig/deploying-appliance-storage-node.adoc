...
+
NOTE: Support for port remapping is deprecated and will be removed in a future release. To remove remapped ports, see https://docs.netapp.com/us-en/storagegrid/maintain/removing-port-remaps.html[removing port remaps on StorageGRID appliances^].
