...
. If your appliance supports Metadata-only storage nodes, select the *Node type*. For more information, see https://review.docs.netapp.com/us-en/storagegrid_main/primer/what-storage-node-is.html#types-of-storage-nodes[Types of Storage Nodes]. 
+
