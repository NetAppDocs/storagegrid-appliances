...
* You have a service laptop with a https://review.docs.netapp.com/us-en/storagegrid-118_main/admin/web-browser-requirements.html[supported web browser^].
...
IMPORTANT: Don't deploy SG100 and SG1000 service appliances in the same site. Unpredictable performance might result.
