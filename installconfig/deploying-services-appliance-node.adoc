...
---
= Deploy a StorageGRID services appliance node
:icons: font
:imagesdir: ../media/
...
* You have a service laptop with a https://docs.netapp.com/us-en/storagegrid/admin/web-browser-requirements.html[supported web browser^].
...
a|
 ...
 .. Select the primary Admin Node for the grid where this appliance Gateway or non-primary Admin Node will be deployed.
 .. Click *Save*.
 .. Wait for the connection state for the new IP address to become ready.
