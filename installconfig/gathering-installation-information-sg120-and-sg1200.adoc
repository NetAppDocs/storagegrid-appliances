...
---
= Gather network information (SG120 and SG1200)
:icons: font
:imagesdir: ../media/
...
Before installing an SG120 or SG1200 services appliance, confirm your StorageGRID system is using a required version of StorageGRID software.

[cols="1a,2a" options="header"]
|===
| Appliance| Required StorageGRID version
| SG1200
| 12.0 or later (latest hotfix recommended)
| SG120
| 12.0 or later (latest hotfix recommended)
|===
...
image::../media/sg120_rj_45_ports.png["SG120 RJ-45 ports"] 

SG1200 RJ-45 ports:

image::../media/sg1200_rj_45_ports.png["SG1200 RJ-45 ports"] 
...
|
For the SG120, choose one of the following:

* Auto (default)
* 10 GbE
* 25 GbE

For the SG1200 with 100G NIC SKU, choose one of the following:
...
*Note:* For the SG1200, 10- and 25-GbE speeds require the use of QSA adapters.

For the SG1200 with 200G NIC SKU, choose one of the following:
...
When link:configuring-network-links.html[configuring network links] for the SG120 and SG1200 appliances, you can use port bonding for the ports that connect to the Grid Network and optional Client Network, and the 1-GbE1/10-GbE management ports that connect to the optional Admin Network. Port bonding helps protect your data by providing redundant paths between StorageGRID networks and the appliance.
...
Fixed port bond mode is the default configuration for the networking ports. The figures show how the network ports on the SG1200 or SG120 are bonded in fixed port bond mode.
...
image::../media/sg120_bonded_management_ports.png["SG120 Bonded Network Management Ports"] 

SG1200:

image::../media/sg1200_bonded_management_ports.png["SG1200 Bonded Network Management Ports"] 
