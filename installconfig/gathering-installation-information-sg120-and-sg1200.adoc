...
image::../media/sg6100_rj_45_ports_circled.png["SG120 RJ-45 ports"] 

SG1200 RJ-45 ports:

image::../media/sg1200_rj_45_ports_circled.png["SG1200 RJ-45 ports"] 
...
For the SG1200, choose one of the following:
...
image::../media/sgf6112_cn_bmc_management_port.png["SG120 management port"] 
...
image::../media/sgf6112_fixed_port.png["SG120 Fixed Port Bond Mode"] 
...
image::../media/sgf6112_aggregate_ports.png["SG120 aggregate port bond mode"] 
...
image::../media/sgf6112_bonded_management_ports.png["SG120 Bonded Network Management Ports"] 
