...
---
= Troubleshoot hardware installation for an SG5800 or SG6100
:icons: font
:imagesdir: ../media/
...
== [[view-boot-codes]]View boot-up codes (SGF6112 and SG6160 only)
...
== [[view-error-codes]]View error codes (SGF6112 and SG6160 only)
