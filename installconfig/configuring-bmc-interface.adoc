...
[.lead]
The user interface for the baseboard management controller (BMC) on the SG6200, SG6100, SG6000, or services appliance provides status information about the hardware and allows you to configure SNMP settings and other options for the appliances.
