...
---
= Troubleshoot hardware installation for an SG6200
:icons: font
:imagesdir: ../media/
...
== [[view-boot-codes]]View boot-up codes (SGF6212 and SG6260 only)
...
== [[view-error-codes]]View error codes (SGF6212 and SG6260 only)
...
=== Expansion shelves don't appear in Appliance Installer (SG6260)
