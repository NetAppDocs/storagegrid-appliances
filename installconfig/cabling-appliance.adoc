...
| 
|Connect to the Grid Network and the Client Network for StorageGRID. See link:../installconfig/port-bond-modes-for-sgf6112.html[Port bond modes (SGF6112)]
...
|10/25-GbE
|Connect to the Grid Network and the Client Network for StorageGRID. See link:../installconfig/port-bond-modes-for-sg6000-cn-controller.html[Port bond modes (SG6000-CN controller)].
...
|Connect to the Grid Network and the Client Network for StorageGRID.  See link:../installconfig/port-bond-modes-for-sg100-and-sg1000.html[Port bond modes (Port bond modes (SG100 and SG1000)].
