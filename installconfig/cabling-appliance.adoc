 ...
 ** For the SG1200, one to four QSFP+, QSFP28, or QSFP56 (200 NIC only) transceivers if you plan to use optical cables for the ports.
...
* 10/25/50/100/200-GbE (200G NIC only)
