...
The figures show the two controllers in the SG5760, with the E4000 series storage controller on the top and the E5800SG controller on the bottom. In the SG5712, the E4000 series storage controller is to the left of the E5800SG controller when viewed from the back.

SG5860 connections:

image::../media/sg5760_connections.gif[Connections on the SG5860 appliance]
...
. If you plan to use SANtricity System Manager, connect management port 1 (P1) on the 40800 controller (the RJ-45 port on the left) to the management network for SANtricity System Manager, using an Ethernet cable.
+
Don't use management port 2 (P2) on the E2800 controller (the RJ-45 port on the right). This port is reserved for technical support.
...
image::../media/sg6000_e2800_connections.png[SG6160 to E4000 Connections]
