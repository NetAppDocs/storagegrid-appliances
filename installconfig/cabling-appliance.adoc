...
* You have one of the following options for the network ports. These items aren't provided with the appliance.
 ** One to four TwinAx cables for connecting the four network ports.
 ** One to eight SFP+, SFP28, QSFP28, or QSFP56 transceivers if you plan to use optical cables for the ports.
...
. If your appliance includes an expansion shelf, see the link:../sg6200/adding-expansion-shelf-to-deployed-sg6200.html[instructions for adding an expansion shelf to a deployed SG6200] for cabling information.
--
