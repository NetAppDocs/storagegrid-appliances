...
*Note:* The SFP28 transceivers included with the appliance support 10-GbE link speeds. If you want to use 25-GbE link speeds for the four network ports, you must provide SFP28 transceivers.
...
. Connect the E4000 controller to the E5800SG controller, using two optical cables and four of the eight SFP28 transceivers.
+
[cols="1a,1a" options="header"]
|===
| Connect this port...| To this port...
