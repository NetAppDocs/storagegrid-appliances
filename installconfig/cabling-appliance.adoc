...
. If your system includes an expansion shelf, see link:../sg6100/adding-expansion-shelf-to-deployed-sg6160.html[instructions for adding an expansion shelf to a deployed SG6160].
--
