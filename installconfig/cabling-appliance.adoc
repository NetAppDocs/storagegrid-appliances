...
The following figures show the ports on the back of the SGF6112 and the three controllers in the SG6200 appliance. The SG6200 appliance includes a SG6200-CN compute controller on top and two E4000 storage controllers on the bottom.
