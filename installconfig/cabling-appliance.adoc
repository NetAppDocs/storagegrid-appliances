...
. If your appliance includes an expansion shelf, see the link:../sg6100/adding-expansion-shelf-to-deployed-sg6160.html[instructions for adding an expansion shelf to a deployed SG6160].
--
