...
+
* One AMD 3.55 GHz processor providing 32 cores (64 threads)
* 256 GB RAM
* 256 GB Internal Boot drive (includes StorageGRID software) 
...
image::../media/sgf6212_rear_connectors.png["SGF6212 Rear View"] 
...
| 1
| Network ports 1-4
| 10/25/40/100/200-GbE, based on cable or transceiver type, switch speed, and configured link speed. 

QSFP56 (max 200GbE/port), QSFP28 (max 100GbE/port), and QSFP+ (40GbE) are supported natively (200GbE speeds require 200GbE NIC option). Optional SFP+ (10GbE) or SFP28 (25GbE) transceivers can be used with a QSA (sold separately).
...
4
a|
E-Series E4000 storage controller (1 of 2) and connectors
a|
5
a|
...
image::../media/s25_rear_leds.png["Rear LEDs SG6200-CN"] 
