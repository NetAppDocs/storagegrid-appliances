...
Additionally, node encryption provides FIPS certified encryption of data at rest when you enable FIPS mode. Refer to https://review.docs.netapp.com/us-en/storagegrid_sgws35312-pc-16jun2025/admin/manage-tls-ssh-policy.html#select-a-security-policy[Select a security policy^] for more information.
...
If you have a StorageGRID appliance with FIPS drives, enabling Drive Encryption provides FIPS certified encryption of data at rest.
