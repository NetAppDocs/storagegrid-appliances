...
+
NOTE: You must have already authenticated with access to the drive before you can disable drive-encryption.

The drive contents is unencrypted, the encryption passphrase is erased, and the SEDs are now accessible without a passphrase.
