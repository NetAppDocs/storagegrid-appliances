...
+
image::../media/monitor_installation_configure_storage.gif["Monitor Installation page"] 
+
...
+
image::../media/monitor_installation_install_sgws.gif["Monitor Installation page"] 
