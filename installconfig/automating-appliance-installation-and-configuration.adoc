...
---
= Automate StorageGRID appliance installation and configuration
:icons: font
:imagesdir: ../media/
...
** Network bond mode
** Link speed
** LACP transmit hash policy and PDU rate
...
* Generate a JSON file that contains configuration details. Work with your NetApp Professional Services consultant to use the link:https://configbuilder.netapp.com/Index.aspx[NetApp ConfigBuilder tool^] (login required) to complete these steps:
...
* You are connected to the StorageGRID Appliance Installer on the appliance you are configuring using a https://docs.netapp.com/us-en/storagegrid/admin/web-browser-requirements.html[supported web browser^].
...
. In the Upload JSON section, browse for and select the JSON configuration file you want to upload.
+
