...
+
The JSON file containing the configuration information is written to the path of the output file specified, in this case the relative path for thr file `appliance-SG1000.json`.
+
