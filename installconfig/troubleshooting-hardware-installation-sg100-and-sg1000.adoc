...
---
= Troubleshoot hardware installation for an SG100 and SG1000
:icons: font
:imagesdir: ../media/
...
If a hardware error occurs when the appliance is booting up, the BMC logs an error code. As required, you can view these error codes using the BMC interface or the appliance serial port, and then work with technical support to resolve the issue.
