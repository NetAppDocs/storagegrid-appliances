...
* You must place the E5700SG controller into https://review.docs.netapp.com/us-en/storagegrid-118_main/maintain/placing-appliance-into-maintenance-mode.html[maintenance mode^], which interrupts the connection to the E2800 controller.
+
...
. Confirm the appliance is in https://review.docs.netapp.com/us-en/storagegrid-118_main/maintain/placing-appliance-into-maintenance-mode.html[maintenance mode^].
