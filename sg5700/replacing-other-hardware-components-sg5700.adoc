...
To replace a drive, power-fan canister, fan canister, power canister, or drive drawer in the appliance, access the http://mysupport.netapp.com/info/web/ECMP1658252.html[E-Series procedures for maintaining E2800 hardware^].
