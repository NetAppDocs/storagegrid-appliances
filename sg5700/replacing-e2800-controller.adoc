...
The appliance Storage Node will not be accessible when you replace the controller. If the E2800 series controller is functioning sufficiently, you can https://review.docs.netapp.com/us-en/storagegrid-118_main/maintain/placing-appliance-into-maintenance-mode.html[place the E5700SG controller into maintenance mode^].
...
.Steps
. If the StorageGRID appliance is running in a StorageGRID system, https://review.docs.netapp.com/us-en/storagegrid-118_main/maintain/placing-appliance-into-maintenance-mode.html[place the E5700SG controller into maintenance mode^].
