...
[.lead]
Go to https://docs.netapp.com/us-en/storagegrid/index.html[StorageGRID 12.1 Documentation^] to learn how to configure and use a StorageGRID 12.1 system.
...
* https://docs.netapp.com/us-en/storagegrid-120/index.html[StorageGRID 12.0 documentation^]
